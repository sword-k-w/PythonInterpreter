...
if [ ! -f "$output_dir/Python3Demo*.java" ]; then
    ...
    java -Xmx500M -cp "/usr/local/lib/antlr-4.13.2-complete.jar:$CLASSPATH" org.antlr.v4.Tool -o "$output_dir" Python3Demo.g4
fi
...
cd "$output_dir" && java -Xmx500M -cp "/usr/local/lib/antlr-4.13.2-complete.jar:$CLASSPATH" org.antlr.v4.gui.TestRig Python3Demo "$@"
